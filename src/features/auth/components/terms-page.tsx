export default function TermsPage() {
  return (
    <div className="prose mx-auto max-w-none space-y-5 p-15 md:max-w-5xl">
      ...
      <p>
        These Terms of Service ("Terms") govern your access to and use of the YourHonor application
        ("Service"), provided by YourHonor ("we", "us", or "our"). By accessing or using the
      ...
      <p>
        The Service is an administrative tool designed for managing honorarium payments and related
        financial data. You agree to use the Service only for its intended purpose and in compliance
      ...
      <p>
        ...
        shall not exceed the greater of the amount paid by you, if any, for accessing the Service or
      ...
      <p>
        ...
        We will provide notice of any changes by updating the "Last updated" date at the top of this
        page. Your continued use of the Service after any such changes constitutes your acceptance
        of the new Terms.
      </p>
