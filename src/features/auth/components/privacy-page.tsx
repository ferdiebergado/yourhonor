  ...
  return (
    <Card className="mx-auto my-15 max-w-prose p-15">
      <CardHeader>
        ...
        <CardDescription>Last updated: May 14, 2026</CardDescription>
      </CardHeader>
      <CardContent className="space-y-5">
        ...
        <h2 className="text-lg font-semibold">1. Interpretation and Definitions</h2>
        ...
        <ul className="space-y-5">
          ...
          <li>
            ...
            downloaded by You on any electronic device, named YourHonor.
          </li>
          <li>
            <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in
            this Agreement) refers to YourHonor.
          </li>
          <li>
          ...
          <li>
            <strong>Service</strong> refers to the Application, an administrative tool designed for
            managing honorarium payments and related financial data.
          </li>
          <li>
        ...
        <h2 className="text-lg font-semibold">2. Collecting and Using Your Personal Data</h2>

        <h3 className="font-medium">Types of Data Collected</h3>

        <h4 className="font-normal">Personal Data</h4>
        <p>
        ...
        <ul className="space-y-5">
          ...
          <li>Profile picture (provided by Google)</li>
        </ul>
        <p>
          This data is solely used for identifying and authenticating users within the application.
          Access to the Service requires a Google account for authentication. We do not store any
          passwords, as authentication is handled through Google OAuth.
        </p>

        <h4 className="font-normal">Financial Data</h4>
        <p>
          For the collected financial information for payment purposes, we ensure that these details
          are encrypted before being stored in our database. This encryption is performed to protect
          sensitive financial information and prevent unauthorized access.
        </p>
        <p>
          The Service is designed for managing honorarium payments and related financial data,
          including but not limited to payee information, bank account details, and activity
          descriptions.
        </p>

        <h3 className="font-medium">Use of Your Personal Data</h3>
        <p>The Company may use Personal Data for the following purposes:</p>
        <ul className="space-y-5">
          <li>
            <strong>To Provide and Maintain our Service</strong>, including monitoring the usage of
            our Service.
          </li>
          <li>
          ...
          <li>
            <strong>For Authentication and Identification:</strong> We use your Google-provided
            name, email, and profile picture exclusively for identifying and authenticating users.
            No other personal information from your Google account is accessed or stored.
          </li>
        </ul>

        <h3 className="font-medium">Retention of Your Personal Data</h3>
        <p>
        ...
        <h3 className="font-medium">Transfer of Your Personal Data</h3>
        <p>
        ...
        <h3 className="font-medium">Delete Your Personal Data</h3>
        <p>
        ...
        <h3 className="font-medium">Disclosure of Your Personal Data</h3>

        <h4 className="font-normal">Business Transactions</h4>
        <p>
        ...
        <h4 className="font-normal">Other Legal Requirements</h4>
        <p>
        ...
        <h2 className="text-lg font-semibold">3. Security of Your Personal Data</h2>
        <p>
        ...
        <p>
          Specifically regarding financial data, We employ industry-standard encryption protocols to
          ensure that these sensitive details are encrypted before being stored in our database.
        </p>

        <h2 className="text-lg font-semibold">4. Children's Privacy</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold">5. Links to Other Websites</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold">6. Changes to this Privacy Policy</h2>
        <p>
