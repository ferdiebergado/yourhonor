    ...
    <div className="prose mx-auto max-w-none space-y-5 p-15 md:max-w-5xl">
      ...
      <ul>
        ...
        <li>
          ...
          by You on any electronic device, named YourHonor.
        </li>
        <li>
          <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
          Agreement) refers to YourHonor.
        </li>
        <li>
      ...
      <p>
        For users who provide financial information for payment purposes, we ensure that these
        details are encrypted before being stored in our database. This encryption is performed to
        protect sensitive financial information and prevent unauthorized access.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          <strong>For Authentication and Identification:</strong> We use your Google-provided name,
          email, and profile picture exclusively for identifying and authenticating users. No other
          personal information from your Google account is accessed or stored.
        </li>
      </ul>
